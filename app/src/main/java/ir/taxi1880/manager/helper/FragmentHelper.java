...
public class FragmentHelper {
  ...
  private static final String TAG = ir.taxi1880.manager.helper.FragmentHelper.class.getSimpleName();
  private static ir.taxi1880.manager.helper.FragmentHelper instance;
   ...
   */
  public static ir.taxi1880.manager.helper.FragmentHelper toFragment(Activity activity, Fragment fragment) {
    instance = new ir.taxi1880.manager.helper.FragmentHelper();
   ...
   * @return instance of FragmentHelper Class
   */
  public static ir.taxi1880.manager.helper.FragmentHelper toFragment(Activity activity, androidx.fragment.app.Fragment fragmentV4) {
    instance = new ir.taxi1880.manager.helper.FragmentHelper();
    instance.activity = activity;
   ...
   */
  public ir.taxi1880.manager.helper.FragmentHelper setUseAnimation(@AnimRes int enterAnim, @AnimRes int exitAnim, @AnimRes int popEnterAnim, @AnimRes int popExitAnim) {
  ...
  public ir.taxi1880.manager.helper.FragmentHelper setUseAnimation(@AnimRes int enterAnim, @AnimRes int exitAnim) {
    instance.enterAnim = enterAnim;
    instance.exitAnim = exitAnim;
    return instance;
  }
   ...
   * @return
   */
  public ir.taxi1880.manager.helper.FragmentHelper setAddToBackStack(boolean addToBackStack) {
    instance.addToBackStack = addToBackStack;
    return instance;
  }

  public ir.taxi1880.manager.helper.FragmentHelper setArguments(Bundle bundle) {
   ...
   * @return
   */
  public ir.taxi1880.manager.helper.FragmentHelper setFrame(int frame) {
  ...
  public static ir.taxi1880.manager.helper.FragmentHelper taskFragment(Activity activity, String tag) {
    instance = new ir.taxi1880.manager.helper.FragmentHelper();
    instance.activity = activity;
    instance.fragmentManagerV4 = ((FragmentActivity) instance.activity).getSupportFragmentManager();
    instance.fragmentManager = instance.activity.getFragmentManager();
  ...
  public ir.taxi1880.manager.helper.FragmentHelper setNavigationBarColor(@ColorInt int color) {
    instance.navigationBarColor = color;
    return instance;
  }

  public ir.taxi1880.manager.helper.FragmentHelper setStatusBarColor(@ColorInt int color) {
