...
public class SalaryDialog {
    ...
    public void editSalary() {
        ...
        RequestHelper.builder(EndPoints.SALARY)
                ...
                .addParam("service", StringHelper.toEnglishDigits(binding.edtTripRegisterPercent.getText() + ""))
                .addParam("error", StringHelper.toEnglishDigits(binding.edtCheckMistakePercent.getText() + ""))
